...
<!--         width="600px" height="600px" viewBox="-91.91 -198.948 600 600" enable-background="new -91.91 -198.948 600 600"-->
<!--         xml:space="preserve">-->
<!---->
<!--        <polyline id="a" fill="none" stroke="#70B62C" stroke-miterlimit="10">-->
<!--            <animate-->
<!--                attributeName="points"-->
<!--                dur="3000ms"-->
<!--                repeatCount="indefinite"-->
<!--                values="161.599,-163.987 131.899,-31.845 102.199,100.297-->
<!--	72.499,232.438 42.799,364.58 102.199,364.58 161.599,364.58 221,364.58 280.401,364.58 250.701,232.438 221,100.297-->
<!--	191.299,-31.845 161.599,-163.987 ;-->
<!---->
<!--	360.291,-52.709 360.291,-163.987 280.401,-163.987-->
<!--	197.261,-163.987 197.261,-52.709 197.261,58.569 197.261,364.58 280.401,364.58 280.401,58.569 316.269,58.569 316.269,-52.709-->
<!--	360.291,-52.709 "/>-->
<!--	</polyline>-->
<!---->
<!---->
