module.exports = function (grunt) {
    grunt.initConfig({
        ...
        bootstrap_folder:'gruntdev/bootstrap',
        dev_folder:'gruntdev',
        dev_css:'/_css',
        dev_js:'/_js',
...
//        },
        ...
        copy:{
            ...
            //lightbox_js:{src:'<%= dev_folder %>/magnific-popup/dist/jquery.magnific-popup.js', dest:'<%= js_folder %>/magnific-popup.js'},
...
//            lightbox_css:{src:'<%= dev_folder %>/magnific-popup/dist/magnific-popup.css', dest:'<%= dev_folder %><%= dev_css %>/lightbox/magnific-popup.less'},
         ...
         //swipebox_css:{src:'<%= dev_folder %>/swipebox/src/css/swipebox.css', dest:'<%= dev_folder %><%= dev_css %>/swipebox/swipebox.less'},
//            swiper3dflow_css:{src:'<%= dev_folder %>/swiper-3d-flow/dist/idangerous.swiper.3dflow.css', dest:'<%= dev_folder %>/less/sliders/idangerous.swiper.3dflow.less'},
            ...
            //touchswipe:{src:'<%= dev_folder %>/jquery-touchswipe/jquery.touchSwipe.min.js', dest:'<%= js_folder %>/touchswipe.js'},
            isotope:{src:'<%= dev_folder %>/isotope-perfectmasonry/example/js/jquery.isotope.min.js', dest:'<%= js_folder %>/osi.js'},
            ilightbox:{src:'<%= dev_folder %>/ilightbox/ilightbox.js', dest:'<%= js_folder %>/ilightbox.js'},
            //swipebox:{src:'<%= dev_folder %>/swipebox/src/js/jquery.swipebox.min.js', dest:'<%= js_folder %>/swipebox.js'},
...
//            llxt_js:{src:'<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.js', dest:'<%= js_folder %>/llxt.js'},
//            llxt_bg_js:{src:'<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.bg.js', dest:'<%= js_folder %>/llxtbg.js'},
//            llxt_al_js:{src:'<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.autoload.js', dest:'<%= js_folder %>/llxtal.js'},
//            src:'<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.extra.js',
//            src:'<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.srcset.js',
        },
...
//            llxt:{
//                src: [
//                    '<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.js',
//                    '<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.bg.js',
//                    '<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.autoload.js',
//                    '<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.extra.js',
//                    '<%= dev_folder %>/lazyloadxt/dist/jquery.lazyloadxt.srcset.js',
//                ],
//                dest: '<%= dev_folder %><%= dev_js %>/lazyloadxt.js'
//            },
...
//            pmasonry:{files:{'<%= js_folder %>/pmasonry.js':['<%= dev_folder %>/isotope-perfectmasonry/jquery.isotope.perfectmasonry.js']}},
            shuffle:{files:{'<%= js_folder %>/shuffle.js':['<%= dev_folder %>/shufflejs/dist/jquery.shuffle.js']}},
            //ilightbox:{files:{'<%= js_folder %>/ilightbox.js':['<%= dev_folder %>/ilightbox/ilightbox.js']}},
            preload:{files:{'<%= js_folder %>/ipreload.js':['<%= dev_folder %>/jQuery.preload/src/jquery.preload.js']}},
//            lazy:{files:{'<%= js_folder %>/lazyload.js':['<%= dev_folder %>/jquery.lazyload/jquery.lazyload.js']}},
//            lazyxt:{files:{'<%= js_folder %>/lxt.js':['<%= dev_folder %><%= dev_js %>/lazyloadxt.js']}},
